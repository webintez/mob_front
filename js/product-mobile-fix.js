    ...
    function forceMobileLayout() {
        ...
        if (window.innerWidth <= 768) {
            ...
            if (productContent) {
                ...
                productContent.style.setProperty('gap', '20px 0', 'important');
                productContent.style.setProperty('grid-row-gap', '20px', 'important');
            ...
            if (productImagesWrapper) {
                ...
                productImagesWrapper.style.setProperty('margin-bottom', '0', 'important');
            }
            ...
            if (productRightColumn) {
                ...
                productRightColumn.style.setProperty('margin-top', '0', 'important');
            }
        }
    }
